...
// const { generalLimiter, strictLimiter, apiLimiter, createAccountLimiter } = require("./middleware/rateLimiter");
...
// })
// .catch((err) => {
//     Logger.error("Database connection failer", error.message);
//     process.exit(1);
// })
...
//         remainig: req.rateLimit?.remaining,
...
// First install the rate limiting package:
// npm install express-rate-limit

// Updated index.js with simple rate limiting
const express = require("express");
